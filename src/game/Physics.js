import {portalState,updatePortals,enterPortal} from './Portals.js?v=0.4.0';
import {roundCorner} from './Bounds.js?v=0.4.0';
import {ARENAS,W,H,CORNER_RADIUS,GOAL,clamp,legalSkill,COOLDOWN} from '../config/game.js?v=0.4.0';
...
export class Physics {
 ...
 resetRound(){this.portals=portalState();this.players=[mallet(1),mallet(-1)];Object.assign(this.puck,{x:0,z:0,vx:0,vz:0,held:-1,hidden:false});this.skills=[null,null];this.phase='countdown';this.wait=3;}
 ...
 snapshot(){return {portals:this.portals,t:this.t,scores:this.scores,players:this.players,puck:this.puck,skills:this.skills,cooldowns:this.cooldowns,phase:this.phase,wait:this.wait,winner:this.winner,goalId:this.goalId,lastScorer:this.lastScorer};}
 apply(s){for(const k of ['portals','t','scores','players','puck','skills','cooldowns','phase','wait','winner','goalId','lastScorer'])this[k]=s[k];}
}
