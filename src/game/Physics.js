import {portalState,updatePortals,enterPortal} from './Portals.js?v=0.5.2';
import {roundCorner} from './Bounds.js?v=0.5.2';
import {ARENAS,W,H,CORNER_RADIUS,GOAL,clamp,legalSkill,COOLDOWN} from '../config/game.js?v=0.5.2';
